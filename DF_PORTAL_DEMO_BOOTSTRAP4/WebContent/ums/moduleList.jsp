								...
								<table class="table table-responsive table-bordered table-hover">
									...
									<tbody>
										<tr class="tr<%= ind.intValue()%2 %>">
											<td align="right" width="3%">&nbsp;<%= ind.intValue()+searchCondition.getPosition()+1 %>&nbsp;</td>
											<td align="right">&nbsp;<nested:write name="result" property="order" />&nbsp;</td>
											<td align="center"><i class="fa fa-<nested:write name="result" property="code" />"></i></td>
				...
				<nested:equal property="canCreate" value="true">
					<div class="row">
						<div class="col text-center">
							<input type="button" value=" เพิ่มข้อมูลระบบงาน " class="btn btn-primary" onclick="doCmd('goCreate')" />
						</div>
					</div>
				</nested:equal>
			</div>
