...
<div class="row">
	<div class="col">
		<div class="box box-danger">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-2 col-sm-3 col-12"><label class="label-form">ไอคอน</label></div>
					<div class="col-md-2 col-sm-4 col-12">
						<nested:text property="formData.code" styleClass="form-control" maxlength="3" lang="property['รหัสระบบงาน',required,3,3]" disabled="<%= !editable.booleanValue() %>" />
					</div>
				</div>
				<div class="row">
					<div class="col-md-2 col-sm-3 col-12"><label class="label-form">ชื่อระบบงาน</label></div>
					<div class="col-md-4 col-sm-8 col-12">
						<nested:text property="formData.name" styleClass="form-control" maxlength="50" lang="property['ชื่อระบบงาน',required,,50]" disabled="<%= !editable.booleanValue() %>" />
					</div>
				</div>
				<div class="row">
			...
			<div class="box-footer">
				...
				<input type="button" value=" กลับไป " class="btn btn-default mt-1" onclick="doCmd('list')" />
			</div>
		</div>
	</div>
</div>
